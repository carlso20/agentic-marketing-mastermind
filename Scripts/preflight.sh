...
QUICKSTART_MAC='  /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/carlso20/agentic-marketing-mastermind/main/Scripts/quickstart-mac.sh)"'
QUICKSTART_WIN='  irm https://raw.githubusercontent.com/carlso20/agentic-marketing-mastermind/main/Scripts/quickstart-windows.ps1 | iex'
...
if [[ "$FAILED" -ne 0 ]]; then
  ...
  echo ""
  if [[ "$OSTYPE" == "darwin"* ]]; then
    echo '  /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/carlso20/agentic-marketing-mastermind/main/Scripts/quickstart-mac.sh)"'
  else
    echo "  irm https://raw.githubusercontent.com/carlso20/agentic-marketing-mastermind/main/Scripts/quickstart-windows.ps1 | iex"
  fi
  echo ""
  exit 1
