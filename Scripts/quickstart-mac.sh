...
#   /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/carlso20/agentic-marketing-mastermind/main/Scripts/quickstart-mac.sh)"

set -e

REPO_URL="https://github.com/carlso20/agentic-marketing-mastermind.git"
QUICKSTART_URL="https://raw.githubusercontent.com/carlso20/agentic-marketing-mastermind/main/Scripts/quickstart-mac.sh"
